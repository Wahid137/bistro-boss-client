...
const BistroBanner = () => {
  return (
    <div className="bistro-img bg-fixed flex justify-center items-center">
      <div className="bg-white bg-opacity-30 w-[1096px] h-[333px] mx-auto flex items-center">
        <div className="flex flex-col justify-center items-center">
          <p className="uppercase text-3xl font-serif">Bistro Boss</p>
          <p className="mx-40 text-justify mt-5 font-serif">
