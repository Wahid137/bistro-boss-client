...
const ChefCards = () => {
  return (
    <section>
      ...
      ></SectionTitle>
      <div className="ms-48 gap-8 md:ms-20 md:gap-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <div className="card w-80 card-compact bg-slate-200 shadow-xl">
          <figure>
        ...
        <div className="card card-compact bg-slate-200 w-80 bg-base-100 shadow-xl">
          <figure>
            <img src={chef1} className="w-[424px] h-[280px]" alt="Shoes" />
          </figure>
          <div className="card-body flex justify-center text-center items-center">
